...
$1.00$ at $\tau \in [55, 68]$ under deploy --- the default configuration
cannot separate abort from continue \emph{at any threshold}, while deploy
yields a wide margin window for the controller to operate in.
